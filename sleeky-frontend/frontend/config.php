...
// reCAPTCHAV3 is a free service that protects your website from spam and abuse. You can get a site and secret key from here: https://www.google.com/recaptcha/admin/create
// hCAPTCHA is an alternative to reCAPTCHA that allows you to earn money on solved tasks. You can get a site and secret key from here: https://www.hcaptcha.com/

// Options: reCaptchaV3 / hCaptcha
define("captchaProvider", 'none');

// Captcha Site Key
define("captchaSiteKey", 'YOUR_SITE_KEY_HERE');

// Captcha Secret Key
define("captchaSecretKey", 'YOUR_SECRET_KEY_HERE');
